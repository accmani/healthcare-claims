...
public class BdsAccumulatorServiceTest {
    ...
    public void testCalculateDeductible_ValidInputs() {
        assertEquals(500, service.calculateDeductible(500));
        assertEquals(1000, service.calculateDeductible(1000));
        assertEquals(1500, service.calculateDeductible(3000));
        assertEquals(2000, service.calculateDeductible(5000));
        assertEquals(3000, service.calculateDeductible(6000));
    }
